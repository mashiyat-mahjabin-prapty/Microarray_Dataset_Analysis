...
os.chdir('F:\Thesis\MicroArray dataset\Multiclass\Endometrial Cancer\RFECV')
...
selected_features = []
# read data
df = pd.read_csv('F:\Thesis\MicroArray dataset\Multiclass\Endometrial Cancer\Endometrial.csv')
