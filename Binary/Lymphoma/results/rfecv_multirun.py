...
os.chdir('F:\Thesis\MicroArray dataset\Binary\lymphoma_preprocessed\RFECV')
...
selected_features = []
# read data
df = pd.read_csv('F:\Thesis\MicroArray dataset\Binary\lymphoma_preprocessed\lymphoma.csv')
