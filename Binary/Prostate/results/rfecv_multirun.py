...
os.chdir('F:\Thesis\MicroArray dataset\Binary\prostate_preprocessed\RFECV')
...
selected_features = []
# read data
df = pd.read_csv('F:\Thesis\MicroArray dataset\Binary\prostate_preprocessed\prostate.csv')
